<?php
    ...
    if ($rol == "Alumne") {
        print_r("Estudiante:" . '<br>');
        print_r('<strong>Nombre:</strong> ' . $respuestaFormat["name"] . '<br>');
        print_r('<strong>Apellido:</strong> ' . $respuestaFormat["surname"] . '<br>');
        print_r('<strong>Correo:</strong> ' . $respuestaFormat["email"]);
    } elseif ($rol == "Professor") {
        // Mostramos los datos en caso de que sea professor
        print_r('Hola ' . $respuestaFormat["name"] . ', eres profesor.' . '<br>');
    ...
    function altresUsuaris($conexion) {
        ...
        while ($user = $respuestaOtrosUsuarios->fetch_assoc()) {
            echo "<strong>Nombre y apellido:</strong> " . $user["name"] . ' ' . $user["surname"] . '<br>';
        }
